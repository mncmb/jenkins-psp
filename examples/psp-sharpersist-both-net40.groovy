        ...
        stage('Nuget-install'){
            steps{
                script{
                    ...
                    try{
                        bat "nuget sources add -Source https://api.nuget.org/v3/index.json "
                    ...
                    bat "nuget install Costura.Fody -Version 3.3.3 -OutputDirectory ${WORKSPACE}\\packages"
                    bat "nuget install TaskScheduler -Version 2.8.11 -OutputDirectory ${WORKSPACE}\\packages"
